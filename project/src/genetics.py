...
class Evolution():
    def __init__(self, dataframe, init_tree_depth = 4, predict_feat='Energie', iterations=100, selection_type = '1+1', n_samples = 100):
    ...
    def evaluation(self):
        ...
        # end_time = time.time()
        # print("UPD: %s seconds" %(end_time - start_time))
